...
class FormTransaksi extends React.Component {
    ...
    tambahPaket(ev) {
        ...
        let selectedPaket = this.state.packs.find(
    ...
    simpanTransaksi() {
        ...
        axios
            .post(endpoint, newData, this.headerConfig())
            .then((response) => {
            ...
            <div className="main-content">
                <div className="card p-3">
                    ...
                    <div className="card-body">
                        ...
                        <div className="d-grid gap-2 d-md-flex justify-content-md-end mt-5">
                            <a className="btn btn-danger btn-md mx-2" href="/transaksi">
                                Batal
                            </a>
                            <button
