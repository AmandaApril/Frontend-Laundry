            ...
            return(
                <div>
                    ...
                    <div className="container">
                        <h3 className="text-bold text-dark mt-2">
                            <FiUsers class="iconmember"/>
                            Member List
                        </h3>
                        <div className="row">
                            ...
                            <div className="modal-content">
                                ...
                                <form onSubmit={ev => this.saveMember(ev)}>
                                        ...
                                        <div className="form-group">
                                            <select name="jenis_kelamin" id="jenis_kelamin exampleFormControlSelect1" className="form-control"
                                            onChange={ev => this.setState({jenis_kelamin: ev.target.value})} value={this.state.jenis_kelamin}>
                                                <option>--- Pilih ---</option>     
